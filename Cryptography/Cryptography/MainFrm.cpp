...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	ON_WM_CREATE()
	ON_COMMAND(ID_32771, &CMainFrame::OnDialog1)
...
{
	// TODO: 在此添加命令处理程序代码
	CEncryptionDialog* pDlg1 = new CEncryptionDialog;
	pDlg1->Create(IDD_DIALOG31);
...
{
	// TODO: 在此添加命令处理程序代码
	CDHEncryptionDialog* pDlg3 = new CDHEncryptionDialog;
	pDlg3->Create(IDD_DIALOG41);
